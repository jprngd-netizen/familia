    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto space-y-6 sm:space-y-8">
      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-theme-primary text-theme-dark px-4 sm:px-6 py-3 rounded-xl sm:rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-theme-secondary shadow-lg shadow-theme-primary/20 transition active:scale-95 text-sm sm:text-base"
        >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl font-bold text-sm whitespace-nowrap transition-all ${
              filter === 'Todos'
                ...
                : 'bg-theme-card border border-theme-border text-gray-400'
            }`}
          >
            Todos
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
        ...
        <aside className="hidden lg:block space-y-4">
          <div className="bg-theme-card p-6 rounded-[2rem] shadow-sm border border-theme-border sticky top-8">
            <h3 className="font-bold text-white mb-4 flex items-center gap-2">
              <Tag size={18} className="text-theme-primary" /> Categorias
            </h3>
            <div className="space-y-2">
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                  filter === 'Todos'
                    ? 'bg-theme-primary text-theme-dark shadow-md'
                    : 'text-gray-400 hover:bg-theme-cardHover'
                }`}
              >
                Todos os Itens
              </button>
          ...
          <div className="bg-theme-primary/10 p-6 rounded-[2rem] border border-theme-primary/20">
            <h3 className="font-bold text-theme-primary mb-2 flex items-center gap-2">
              <Star size={18} /> Dica de Gestor
            </h3>
            <p className="text-xs text-theme-secondary/80 leading-relaxed font-medium">
        ...
        <div className="lg:col-span-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            {filteredRewards.map(reward => (
              <div
                key={reward.id}
                className="bg-theme-card p-4 sm:p-6 rounded-2xl sm:rounded-[2.5rem] shadow-sm border border-theme-border group hover:border-theme-primary/30 transition-all flex gap-4 sm:gap-5"
              >
                <div className="w-14 h-14 sm:w-20 sm:h-20 bg-theme-dark rounded-xl sm:rounded-[1.5rem] flex items-center justify-center text-2xl sm:text-4xl shadow-inner border border-theme-border flex-shrink-0 group-hover:scale-110 transition-transform">
                  {reward.icon}
                </div>
                <div className="flex-1 flex flex-col justify-between overflow-hidden min-w-0">
                    ...
                    <div className="flex justify-between items-start gap-2">
                      ...
                      <div className="flex gap-1 sm:gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition shrink-0">
                        <button
                          ...
                          className="text-gray-500 hover:text-theme-primary p-1"
                        >
                          <Edit2 size={14} className="sm:w-4 sm:h-4" />
                        </button>
                        <button
                          onClick={() => onDeleteReward(reward.id)}
                          className="text-gray-500 hover:text-theme-danger p-1"
                        >
                          <Trash2 size={14} className="sm:w-4 sm:h-4" />
                        </button>
                      </div>
                    </div>
                    <p className="text-[9px] sm:text-[10px] font-black text-theme-primary uppercase tracking-widest mt-0.5">
                      {reward.category}
                    </p>
                  ...
                  <div className="flex items-center gap-2 mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-theme-border">
                    <span className="bg-theme-primary/10 text-theme-primary px-2 sm:px-3 py-1 rounded-full text-[9px] sm:text-[10px] font-black tracking-wider uppercase flex items-center gap-1">
            ...
            {filteredRewards.length === 0 && (
              <div className="col-span-full py-12 sm:py-20 text-center bg-theme-dark rounded-2xl sm:rounded-[3rem] border-2 border-dashed border-theme-border">
                ...
                <button onClick={handleOpenAdd} className="mt-4 text-theme-primary font-bold hover:underline text-sm sm:text-base">
          ...
          <div className="bg-theme-card border border-theme-border rounded-t-3xl sm:rounded-[3rem] p-6 sm:p-10 w-full sm:max-w-md shadow-2xl animate-in slide-in-from-bottom sm:zoom-in duration-200 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6 sm:mb-8">
              ...
              <button
                ...
                className="p-2 hover:bg-theme-cardHover rounded-xl transition sm:hidden"
              >
            ...
            <div className="space-y-4 sm:space-y-5 mb-8 sm:mb-10">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-theme-dark border border-theme-border rounded-xl sm:rounded-2xl px-4 sm:px-5 py-3 sm:py-4 outline-none focus:border-theme-primary text-white text-sm sm:text-base"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-theme-dark border border-theme-border rounded-xl sm:rounded-2xl px-4 sm:px-5 py-3 sm:py-4 outline-none focus:border-theme-primary h-20 sm:h-24 resize-none text-white text-sm sm:text-base"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-theme-dark border border-theme-border rounded-xl sm:rounded-2xl px-4 sm:px-5 py-3 sm:py-4 outline-none text-white text-sm sm:text-base"
                >
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full py-3 sm:py-4 bg-theme-primary text-theme-dark font-bold rounded-xl sm:rounded-2xl shadow-xl hover:bg-theme-secondary transition text-sm sm:text-base"
              >
